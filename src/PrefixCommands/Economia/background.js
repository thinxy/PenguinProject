    ...
    collector.on("collect", async (i) => {
      ...
      if (i.customId === "next") {
        ...
        if (user.dataValues.money < embeds[page].value)
          return i.followUp({
            content: `${this.client.emoji.error} **-** ${message.author}, você não possui dinheiro suficiente para comprar esse background.`,
            ephemeral: true,
          });
        ...
        array_users.push(embeds[page].image);
        ...
        message.reply({
          content: `🛒 | ${message.author}, background **${embeds[page].name}** comprado com sucesso!`,
        });
      } else if (i.customId === "equip") {
        if (!user.dataValues.background.includes(embeds[page].image))
          return i.followUp({
            content: `${this.client.emoji.error} **-** ${message.author} você não tem esse background.`,
            ephemeral: true,
          });
        ...
        message.reply({
          content: `📥 | ${message.author}, background **${embeds[page].name}** equipado com sucesso!`,
        });
      }
    });
  }
