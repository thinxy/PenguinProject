...
export default class CooldownCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['cd','tempo-espera'],
      help: {
        usage: "{prefix}cooldowns [@user]",
      },
    });
  }
  async run(message, args, prefix) {
    ...
    if (message.author.id == message.author.id) {
      let embed = new EmbedBuilder()
        ...
        .setDescription(
          `*${message.author}, aqui esta a sua lista de espera de comandos, junto com eles irá aparecer (✅​) quando estiver pronto e (❌​) quando estiver indisponível.*`
        )
        .setTimestamp()
      ...
      let embed = new EmbedBuilder()
        ...
        .setDescription(
          `*${message.author}, aqui esta a sua lista de espera de comandos, junto com eles irá aparecer (☑️​) quando estiver pronto e (❌​) quando estiver indisponível.*`
        )
        .setTimestamp()
        .setColor(this.client.config.color)
        .addFields({
